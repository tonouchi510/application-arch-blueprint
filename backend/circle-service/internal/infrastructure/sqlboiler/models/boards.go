...
func (boardL) LoadCircle(ctx context.Context, e boil.ContextExecutor, singular bool, maybeBoard any, mods queries.Applicator) error {
	var slice []*Board
	var object *Board
...
// loaded structs of the objects. This is for an N-1 relationship.
func (boardL) LoadOwner(ctx context.Context, e boil.ContextExecutor, singular bool, maybeBoard any, mods queries.Applicator) error {
	var slice []*Board
	var object *Board
...
func (boardL) LoadPosts(ctx context.Context, e boil.ContextExecutor, singular bool, maybeBoard any, mods queries.Applicator) error {
	var slice []*Board
	var object *Board
