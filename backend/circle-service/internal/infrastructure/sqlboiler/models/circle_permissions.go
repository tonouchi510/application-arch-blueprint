...
func (circlePermissionL) LoadCircle(ctx context.Context, e boil.ContextExecutor, singular bool, maybeCirclePermission any, mods queries.Applicator) error {
...
func (o *CirclePermission) SetCircle(ctx context.Context, exec boil.ContextExecutor, insert bool, related *Circle) error {
	...
	values := []any{related.UUID, o.CircleUUID}
