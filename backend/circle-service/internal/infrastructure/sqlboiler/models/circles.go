...
func (circleL) LoadOwner(ctx context.Context, e boil.ContextExecutor, singular bool, maybeCircle any, mods queries.Applicator) error {
	var slice []*Circle
	var object *Circle
...
func (circleL) LoadCirclePermission(ctx context.Context, e boil.ContextExecutor, singular bool, maybeCircle any, mods queries.Applicator) error {
	var slice []*Circle
	var object *Circle
...
func (circleL) LoadBoards(ctx context.Context, e boil.ContextExecutor, singular bool, maybeCircle any, mods queries.Applicator) error {
	var slice []*Circle
	var object *Circle
...
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (circleL) LoadCircleMembers(ctx context.Context, e boil.ContextExecutor, singular bool, maybeCircle any, mods queries.Applicator) error {
	var slice []*Circle
	var object *Circle
...
func (o *Circle) SetCirclePermission(ctx context.Context, exec boil.ContextExecutor, insert bool, related *CirclePermission) error {
	...
	if insert {
		...
		values := []any{o.UUID, related.CircleUUID}
