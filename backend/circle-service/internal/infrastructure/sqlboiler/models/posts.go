...
func (postL) LoadBoard(ctx context.Context, e boil.ContextExecutor, singular bool, maybePost any, mods queries.Applicator) error {
	var slice []*Post
	var object *Post
...
func (o *Post) SetBoard(ctx context.Context, exec boil.ContextExecutor, insert bool, related *Board) error {
	...
	values := []any{related.UUID, o.UUID}
