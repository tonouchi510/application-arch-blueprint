...
type userR struct {
	OwnerBoards   BoardSlice        `boil:"OwnerBoards" json:"OwnerBoards" toml:"OwnerBoards" yaml:"OwnerBoards"`
...
func (o *User) GetOwnerBoards() BoardSlice {
	if o == nil {
		return nil
	}

	return o.R.GetOwnerBoards()
}

func (r *userR) GetOwnerBoards() BoardSlice {
	if r == nil {
		return nil
	}

	return r.OwnerBoards
}

func (o *User) GetCircleMembers() CircleMemberSlice {
	if o == nil {
		return nil
	}
...
func (r *userR) GetCircleMembers() CircleMemberSlice {
	if r == nil {
		return nil
	}
...
func (o *User) GetOwnerCircles() CircleSlice {
	if o == nil {
		return nil
	}

	return o.R.GetOwnerCircles()
}

func (r *userR) GetOwnerCircles() CircleSlice {
	if r == nil {
		return nil
	}

	return r.OwnerCircles
}
...
var (
	userAllColumns            = []string{"id", "name", "email", "email_verified", "photo_url", "phone_number", "created_at", "updated_at", "deleted_at"}
	userColumnsWithoutDefault = []string{"id", "name", "email", "email_verified"}
	userColumnsWithDefault    = []string{"photo_url", "phone_number", "created_at", "updated_at", "deleted_at"}
...
// OwnerBoards retrieves all the board's Boards with an executor via owner_id column.
func (o *User) OwnerBoards(mods ...qm.QueryMod) boardQuery {
...
func (o *User) CircleMembers(mods ...qm.QueryMod) circleMemberQuery {
	var queryMods []qm.QueryMod
	if len(mods) != 0 {
		queryMods = append(queryMods, mods...)
	}
	...
	queryMods = append(queryMods,
		qm.Where("\"circle_members\".\"user_id\"=?", o.ID),
	)
...
func (o *User) OwnerCircles(mods ...qm.QueryMod) circleQuery {
	...
	queryMods = append(queryMods,
		qm.Where("\"circles\".\"owner_id\"=?", o.ID),
	)
...
// LoadOwnerBoards allows an eager lookup of values, cached into the
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (userL) LoadOwnerBoards(ctx context.Context, e boil.ContextExecutor, singular bool, maybeUser any, mods queries.Applicator) error {
	var slice []*User
	var object *User
	...
	query := NewQuery(
		qm.From(`boards`),
		qm.WhereIn(`boards.owner_id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
	...
	if singular {
		object.R.OwnerBoards = resultSlice
	...
	for _, foreign := range resultSlice {
		for _, local := range slice {
			if local.ID == foreign.OwnerID {
				local.R.OwnerBoards = append(local.R.OwnerBoards, foreign)
				if foreign.R == nil {
					foreign.R = &boardR{}
				}
...
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (userL) LoadCircleMembers(ctx context.Context, e boil.ContextExecutor, singular bool, maybeUser any, mods queries.Applicator) error {
	var slice []*User
	var object *User
	...
	query := NewQuery(
		...
		qm.WhereIn(`circle_members.user_id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (userL) LoadOwnerCircles(ctx context.Context, e boil.ContextExecutor, singular bool, maybeUser any, mods queries.Applicator) error {
	var slice []*User
	var object *User
	...
	query := NewQuery(
		qm.From(`circles`),
		qm.WhereIn(`circles.owner_id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
	...
	results, err := query.QueryContext(ctx, e)
	if err != nil {
		return errors.Wrap(err, "failed to eager load circles")
	}

	var resultSlice []*Circle
	if err = queries.Bind(results, &resultSlice); err != nil {
		return errors.Wrap(err, "failed to bind eager loaded slice circles")
	}

	if err = results.Close(); err != nil {
		return errors.Wrap(err, "failed to close results in eager load on circles")
	}
	if err = results.Err(); err != nil {
...
// AddOwnerBoardsG adds the given related objects to the existing relationships
// of the user, optionally inserting them as new records.
// Appends related to o.R.OwnerBoards.
// Sets related.R.Owner appropriately.
// Uses the global database handle.
func (o *User) AddOwnerBoardsG(ctx context.Context, insert bool, related ...*Board) error {
	return o.AddOwnerBoards(ctx, boil.GetContextDB(), insert, related...)
}

// AddOwnerBoards adds the given related objects to the existing relationships
// of the user, optionally inserting them as new records.
// Appends related to o.R.OwnerBoards.
// Sets related.R.Owner appropriately.
func (o *User) AddOwnerBoards(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*Board) error {
	var err error
	...
	if o.R == nil {
		...
		o.R.OwnerBoards = append(o.R.OwnerBoards, related...)
	}
...
// Uses the global database handle.
func (o *User) AddCircleMembersG(ctx context.Context, insert bool, related ...*CircleMember) error {
...
// Appends related to o.R.CircleMembers.
// Sets related.R.User appropriately.
func (o *User) AddCircleMembers(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*CircleMember) error {
	var err error
	for _, rel := range related {
		if insert {
			rel.UserID = o.ID
...
func (o UserSlice) BulkInsert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	ln := int64(len(o))
	if ln == 0 {
		return nil
	}
