...
//
//	mockgen -source=iboard_repository.go -destination=../../../../test/mock/domain/models/boards/iboard_repository.go
//
...
func (mr *MockIBoardRepositoryMockRecorder) AddPost(ctx, boardUuid, post, executor any) *gomock.Call {
...
func (mr *MockIBoardRepositoryMockRecorder) Delete(ctx, boardUuid, executor any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockIBoardRepositoryMockRecorder) Find(ctx, boardUuid, executor any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockIBoardRepositoryMockRecorder) Save(ctx, board, executor any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
