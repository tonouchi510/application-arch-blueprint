...
//
//	mockgen -source=circle_service.go -destination=../../../../test/mock/domain/models/circles/circle_service.go
//
...
func (mr *MockICircleServiceMockRecorder) AddNewCircleMember(ctx, circle, memberId, executor any) *gomock.Call {
...
func (mr *MockICircleServiceMockRecorder) DelegateOwner(ctx, circle, newOwnerId, executor any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockICircleServiceMockRecorder) Exists(ctx, circle, executor any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockICircleServiceMockRecorder) LeaveCircleMember(ctx, circle, memberId, executor any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
