...
//
//	mockgen -source=icircle_repository.go -destination=../../../../test/mock/domain/models/circles/icircle_repository.go
//
...
func (mr *MockICircleRepositoryMockRecorder) AddCircleMember(ctx, circle, userId, executor any) *gomock.Call {
...
func (mr *MockICircleRepositoryMockRecorder) Delete(ctx, circle, executor any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockICircleRepositoryMockRecorder) Find(ctx, id, executor any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockICircleRepositoryMockRecorder) FindByName(ctx, name, executor any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockICircleRepositoryMockRecorder) RemoveCircleMember(ctx, circle, userId, executor any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockICircleRepositoryMockRecorder) Save(ctx, circle, executor any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
