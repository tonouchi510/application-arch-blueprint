...
//
//	mockgen -source=db.go -destination=../../../test/mock/shared/db/db.go
//
...
func (m *MockDbExecutor) Exec(query string, args ...any) (sql.Result, error) {
	m.ctrl.T.Helper()
	varargs := []any{query}
	for _, a := range args {
...
func (mr *MockDbExecutorMockRecorder) Exec(query any, args ...any) *gomock.Call {
...
func (m *MockDbExecutor) Query(query string, args ...any) (*sql.Rows, error) {
	m.ctrl.T.Helper()
	varargs := []any{query}
	for _, a := range args {
		varargs = append(varargs, a)
...
func (mr *MockDbExecutorMockRecorder) Query(query any, args ...any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]any{query}, args...)
...
func (m *MockDbExecutor) QueryRow(query string, args ...any) *sql.Row {
	m.ctrl.T.Helper()
	varargs := []any{query}
	for _, a := range args {
		varargs = append(varargs, a)
...
func (mr *MockDbExecutorMockRecorder) QueryRow(query any, args ...any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]any{query}, args...)
