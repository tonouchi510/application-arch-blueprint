...
class _$GGetUsersDataSerializer implements StructuredSerializer<GGetUsersData> {
  ...
  GGetUsersData deserialize(
    ...
    final result = GGetUsersDataBuilder();
...
class _$GGetUsersData_usersSerializer
  ...
  GGetUsersData_users deserialize(
    ...
    final result = GGetUsersData_usersBuilder();
...
class _$GGetUsersData extends GGetUsersData {
  ...
  @override
  final BuiltList<GGetUsersData_users> users;

  factory _$GGetUsersData([void Function(GGetUsersDataBuilder)? updates]) =>
      (GGetUsersDataBuilder()..update(updates))._build();

  _$GGetUsersData._({required this.G__typename, required this.users})
    : super._();
  @override
  ...
  @override
  GGetUsersDataBuilder toBuilder() => GGetUsersDataBuilder()..replace(this);
...
class GGetUsersDataBuilder
  ...
  ListBuilder<GGetUsersData_users>? _users;
  ListBuilder<GGetUsersData_users> get users =>
      _$this._users ??= ListBuilder<GGetUsersData_users>();
  set users(ListBuilder<GGetUsersData_users>? users) => _$this._users = users;
...
class _$GGetUsersData_users extends GGetUsersData_users {
  ...
  ]) => (GGetUsersData_usersBuilder()..update(updates))._build();
  ...
  GGetUsersData_usersBuilder toBuilder() =>
      GGetUsersData_usersBuilder()..replace(this);
